  ...
  _DOM.DOMSelectors.searchBar.addEventListener("keyup", function (e) {
    ...
    var searchInit = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var query, response, list, champNames;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = "http://ddragon.leagueoflegends.com/cdn/10.24.1/data/en_US/champion/".concat(searchPara, ".json");
...
exports.click = click;
click();
},{"./DOM":"js/DOM.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            support = "Support";
            marksman = "Marksman";
            champFighter = champNames.filter(function (champ) {
              return champ.tags.indexOf(fighter) >= 0;
            });
            champTank = champNames.filter(function (champ) {
              return champ.tags.indexOf(tank) >= 0;
            });
            champMage = champNames.filter(function (champ) {
              return champ.tags.indexOf(mage) >= 0;
            });
            champAssassin = champNames.filter(function (champ) {
              return champ.tags.indexOf(assassin) >= 0;
            });
            champSupport = champNames.filter(function (champ) {
              return champ.tags.indexOf(support) >= 0;
            });
            champMarksman = champNames.filter(function (champ) {
            ...
            _DOM.DOMSelectors.allButton.addEventListener("click", function (e) {
              _DOM.DOMSelectors.displayContainer.innerHTML = "";
              champNames.forEach(function (champ) {
            ...
            _DOM.DOMSelectors.fighterButton.addEventListener("click", function (e) {
              _DOM.DOMSelectors.displayContainer.innerHTML = "";
              champFighter.forEach(function (champ) {
                //stats had the same issue as the actual values, turned them into an array to display them
                var stats = Object.values(champ.info);
            ...
            _DOM.DOMSelectors.tankButton.addEventListener("click", function (e) {
              _DOM.DOMSelectors.displayContainer.innerHTML = "";
              champTank.forEach(function (champ) {
                //stats had the same issue as the actual values, turned them into an array to display them
                var stats = Object.values(champ.info);
            ...
            _DOM.DOMSelectors.mageButton.addEventListener("click", function (e) {
              _DOM.DOMSelectors.displayContainer.innerHTML = "";
              champMage.forEach(function (champ) {
                //stats had the same issue as the actual values, turned them into an array to display them
                var stats = Object.values(champ.info);
            ...
            _DOM.DOMSelectors.assassinButton.addEventListener("click", function (e) {
              _DOM.DOMSelectors.displayContainer.innerHTML = "";
              champAssassin.forEach(function (champ) {
                //stats had the same issue as the actual values, turned them into an array to display them
                var stats = Object.values(champ.info);
            ...
            _DOM.DOMSelectors.supportButton.addEventListener("click", function (e) {
              _DOM.DOMSelectors.displayContainer.innerHTML = "";
              champSupport.forEach(function (champ) {
                //stats had the same issue as the actual values, turned them into an array to display them
                var stats = Object.values(champ.info);
            ...
            _DOM.DOMSelectors.marksmanButton.addEventListener("click", function (e) {
              _DOM.DOMSelectors.displayContainer.innerHTML = "";
              champMarksman.forEach(function (champ) {
                //stats had the same issue as the actual values, turned them into an array to display them
                var stats = Object.values(champ.info);
...
init();
},{"./DOM":"js/DOM.js","./search":"js/search.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
